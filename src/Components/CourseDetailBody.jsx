  ...
  Listed courses START */}
    <section className="pt-0">
      <div className="container">
        {/* Title */}
        <div className="row mb-4">
          <h2 className="mb-0">Top Attended Courses</h2>
        </div>
        <div className="row">
          {/* Slider START */}
          <div className="tiny-slider arrow-round arrow-blur arrow-hover">
            <div className="tns-outer" id="tns1-ow">
              <div
                ...
                aria-atomic="true"
              >
                slide <span className="current">7 to 11</span> of 4
              </div>
                ...
                <div className="tns-inner" id="tns1-iw">
                  <div
                    ...
                    style={{
                      ...
                      transform: "translate3d(-38.8889%, 0px, 0px)"
                    }}
                  >
                    <div
                    ...
                    <div className="pb-4 tns-item tns-slide-cloned tns-slide-active">
                      <div className="card p-2 border">
                        <div className="rounded-top overflow-hidden">
                          <div className="card-overlay-hover">
                            <img
