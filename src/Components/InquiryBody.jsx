      ...
      <div className="container position-relative z-index-9">
        <div className="row g-4 g-sm-5 justify-content-between">
          ...
          <div className="col-lg-6 col-xl-5">
            {/* Title */}
            <h3>
              Get awesome experience in an online class with our superior
              instructor
            </h3>
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-3">
                    ...
                    <p className="text-truncate-2 mb-0">
                      Man children rejoiced yet uncommonly his ten who. Yet
              ...
              <div className="col-12 mb-5">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-3">
                    ...
                    <p className="text-truncate-2 mb-0">
                      Children rejoiced yet uncommonly his ten who. Yet uncommonly
