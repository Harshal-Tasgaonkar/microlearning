            ...
            <div className="tiny-slider arrow-round arrow-creative arrow-blur arrow-hover mt-2 mt-sm-5">
              <div className="tns-outer" id="tns1-ow">
                <div
                  ...
                  aria-atomic="true"
                >
                  slide <span className="current">13 to 16</span> of 5
                </div>
                <div id="tns1-mw" className="tns-ovh">
                  <div className="tns-inner" id="tns1-iw">
                    <div
                      ...
                      id="tns1"
                      style={{
                        transform: "translate3d(-57.1429%, 0px, 0px)",
                        transitionDuration: "0s"
                      }}
                    >
                      <div
                        className="text-center tns-item tns-slide-cloned"
                        aria-hidden="true"
                        tabIndex={-1}
                      >
                        {/* Avatar */}
                      ...
                      {/* Avatar item */}
                      <div
                        className="text-center tns-item"
                        id="tns1-item0"
                        aria-hidden="true"
                        tabIndex={-1}
                      >
