...
const BecomeInstructorBody = () => {
  ...
  // Helper function to capitalize the first letter of summary
  ...
  const handleSubmit = async (e) => {
    ...
    const formattedSummary = capitalizeFirstLetter(summary);
    ...
    try {
      await push(ref(database, "teacherinquiry"), inquiryData);
        ...
        <div className="row g-4 align-items-center">
          <div className="col-md-6">
            ...
            <p>
              ...
              be. Delivered dejection necessary objection do Mr prevailed. Mr
        ...
        <div className="row g-4 g-md-5">
          ...
          <div className="col-md-4 text-center">
            ...
            <p className="text-truncate-2 mb-0">
              ...
              perpetual his you. Feel sold off felt nay rose met you. We so
          ...
          <div className="col-md-4 text-center">
            ...
            <p className="text-truncate-2 mb-0">
              ...
              decisively. Delivered dejection necessary objection do Mr prevailed.
              ...
              >
                ...
                <ul className="list-group list-group-borderless mb-3">
                  ...
                  <li className="list-group-item d-flex">
                    ...
                    Thar where it came from it would have been rewritten a
                    thousand times and everything that was left from origin would
                    be the world
                  </li>
                  <li className="list-group-item">
                    <i className="fas fa-check-circle text-success me-2" />
...
export default BecomeInstructorBody